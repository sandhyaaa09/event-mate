...
import com.saisandhya.event_mate.dto.EventSectionDto;
import com.saisandhya.event_mate.entity.Event;
import com.saisandhya.event_mate.entity.EventSection;
import com.saisandhya.event_mate.exception.ResourceNotFoundException;
    ...
    private void validateEvent(EventDto eventDto) {
        if (eventDto.getStartDate() != null && eventDto.getEndDate() != null) {
            if (eventDto.getStartDate().isAfter(eventDto.getEndDate())) {
                throw new com.saisandhya.event_mate.exception.BadRequestException(
