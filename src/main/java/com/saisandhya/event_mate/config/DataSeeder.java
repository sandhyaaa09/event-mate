package com.saisandhya.event_mate.config;

import com.saisandhya.event_mate.entity.Event;
import com.saisandhya.event_mate.entity.EventSection;
import com.saisandhya.event_mate.entity.SeatingLayout;
import com.saisandhya.event_mate.entity.Role;
import com.saisandhya.event_mate.entity.User;
import com.saisandhya.event_mate.repository.SeatingLayoutRepository;
import com.saisandhya.event_mate.repository.UserRepository;
...
public class DataSeeder {
        ...
        CommandLineRunner initLayouts(SeatingLayoutRepository layoutRepository,
                        com.saisandhya.event_mate.repository.EventRepository eventRepository,
                        com.saisandhya.event_mate.repository.EventSectionRepository sectionRepository,
                ...
                return args -> {
                        transactionTemplate.execute(status -> {
                                ...
                                if (!eventRepository.existsByTitle("Inception")) {
                                        com.saisandhya.event_mate.entity.Event movie = com.saisandhya.event_mate.entity.Event
                                                        .builder()
                                                        .title("Inception")
                                                        .description(
                                ...
                                if (!eventRepository.existsByTitle("Coldplay Live")) {
                                        com.saisandhya.event_mate.entity.Event concert = com.saisandhya.event_mate.entity.Event
                                                        .builder()
                                                        .title("Coldplay Live")
                                                        .description(
                                ...
                                if (!eventRepository.existsByTitle("Standup Special")) {
                                        com.saisandhya.event_mate.entity.Event comedy = com.saisandhya.event_mate.entity.Event
                                                        .builder()
